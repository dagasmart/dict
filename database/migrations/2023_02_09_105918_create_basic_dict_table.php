...
return new class extends Migration
{
    ...
    public function fillInitialData(): void
    {
        ...
        $model->query()->insert([
            ...
            ['id'=>3, 'parent_id'=>1, 'key'=>'kodo', 'enabled'=>1, 'sort'=>1, 'value'=>'七牛云kodo'],
            ['id'=>4, 'parent_id'=>1, 'key'=>'cos', 'enabled'=>1, 'sort'=>2, 'value'=>'腾讯云COS'],
            ['id'=>5, 'parent_id'=>1, 'key'=>'oss', 'enabled'=>1, 'sort'=>3, 'value'=>'阿里云OSS'],
            ['id'=>6, 'parent_id'=>0, 'key'=>'erp.purchase.status', 'enabled'=>1, 'sort'=>0, 'value'=>'采购状态'],
            ['id'=>7, 'parent_id'=>6, 'key'=>'0', 'enabled'=>1, 'sort'=>0, 'value'=>'待审核'],
            ['id'=>8, 'parent_id'=>6, 'key'=>'1', 'enabled'=>1, 'sort'=>1, 'value'=>'采购中'],
            ['id'=>9, 'parent_id'=>6, 'key'=>'2', 'enabled'=>1, 'sort'=>2, 'value'=>'入库中'],
            ['id'=>10, 'parent_id'=>6, 'key'=>'3', 'enabled'=>1, 'sort'=>3, 'value'=>'已完成'],
            ['id'=>11, 'parent_id'=>6, 'key'=>'4', 'enabled'=>1, 'sort'=>4, 'value'=>'已拒绝'],
            ['id'=>12, 'parent_id'=>6, 'key'=>'5', 'enabled'=>1, 'sort'=>5, 'value'=>'待提交'],
            ...
            ['id'=>15, 'parent_id'=>13, 'key'=>'1', 'enabled'=>1, 'sort'=>1, 'value'=>'账期结算'],
            ['id'=>16, 'parent_id'=>13, 'key'=>'2', 'enabled'=>1, 'sort'=>2, 'value'=>'预付款'],
            ['id'=>17, 'parent_id'=>13, 'key'=>'3', 'enabled'=>1, 'sort'=>3, 'value'=>'银行转账'],
            ['id'=>18, 'parent_id'=>13, 'key'=>'4', 'enabled'=>1, 'sort'=>4, 'value'=>'现金支付'],
            ['id'=>19, 'parent_id'=>13, 'key'=>'5', 'enabled'=>1, 'sort'=>5, 'value'=>'在线支付'],
            ['id'=>20, 'parent_id'=>13, 'key'=>'6', 'enabled'=>1, 'sort'=>6, 'value'=>'其他方式'],
            ['id'=>21, 'parent_id'=>0, 'key'=>'erp.goods.status', 'enabled'=>1, 'sort'=>0, 'value'=>'商品状态'],
            ['id'=>22, 'parent_id'=>21, 'key'=>'1', 'enabled'=>1, 'sort'=>1, 'value'=>'正常'],
            ['id'=>23, 'parent_id'=>21, 'key'=>'2', 'enabled'=>1, 'sort'=>2, 'value'=>'下架'],
            ['id'=>24, 'parent_id'=>21, 'key'=>'3', 'enabled'=>1, 'sort'=>3, 'value'=>'停售'],
            ['id'=>25, 'parent_id'=>21, 'key'=>'4', 'enabled'=>1, 'sort'=>4, 'value'=>'停产'],
            ...
            ['id'=>28, 'parent_id'=>26, 'key'=>'1', 'enabled'=>1, 'sort'=>1, 'value'=>'已通过'],
            ['id'=>29, 'parent_id'=>26, 'key'=>'2', 'enabled'=>1, 'sort'=>2, 'value'=>'已拒绝'],
            ['id'=>30, 'parent_id'=>0, 'key'=>'system.basic.state', 'enabled'=>1, 'sort'=>0, 'value'=>'启用状态'],
            ['id'=>31, 'parent_id'=>30, 'key'=>'0', 'enabled'=>1, 'sort'=>0, 'value'=>'关闭'],
            ['id'=>32, 'parent_id'=>30, 'key'=>'1', 'enabled'=>1, 'sort'=>1, 'value'=>'开启'],
            ['id'=>33, 'parent_id'=>0, 'key'=>'open.auth.audit_status', 'enabled'=>1, 'sort'=>0, 'value'=>'认证审核状态'],
            ['id'=>34, 'parent_id'=>33, 'key'=>'0', 'enabled'=>1, 'sort'=>0, 'value'=>'待审'],
            ['id'=>35, 'parent_id'=>33, 'key'=>'1', 'enabled'=>1, 'sort'=>1, 'value'=>'通过'],
            ['id'=>36, 'parent_id'=>33, 'key'=>'2', 'enabled'=>1, 'sort'=>2, 'value'=>'驳回'],
